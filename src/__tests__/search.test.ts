...
describe('SearchResource.search() Unit Tests', () => {
  ...
  describe('search method', () => {
    it('should make POST request to correct endpoint with search criteria', async () => {
      ...
      const postSpy = jest.spyOn(mockClient, 'post').mockResolvedValue(mockResponse);
    ...
    it('should pass query parameters correctly', async () => {
      ...
      const postSpy = jest.spyOn(mockClient, 'post').mockResolvedValue({ status: 200, data: {}, headers: {} });
