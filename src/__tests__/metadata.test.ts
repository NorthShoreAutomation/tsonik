...
import { MetadataResponse, GetMetadataParams, UpdateMetadataRequest, PutMetadataParams, MetadataFieldDefinition, PatchMetadataFieldRequest } from '../types/metadata';
...
describe('MetadataResource', () => {
  ...
  describe('createMetadataField', () => {
    ...
    it('should validate required fields and throw appropriate errors', async () => {
      ...
      await expect(client.metadata.createMetadataField(null as any)).rejects.toThrow('Field data is required');
  ...
  describe('patchMetadataField', () => {
    ...
    it('should validate required parameters and throw appropriate errors', async () => {
      ...
      await expect(client.metadata.patchMetadataField('TestField', null as any)).rejects.toThrow('Patch data is required');
